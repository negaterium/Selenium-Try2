...
public class AppTest {
    ...
    public void sortBy() {
        ...
        WebElement sortByButton = cDriver.findElement(By.cssSelector(".category-products > div.toolbar > div.sorter > div > select"));
        Assert.assertNotNull(sortByButton);
        List<WebElement> sortButtons = cDriver.findElements(By.cssSelector("div.category-products > div.toolbar > div.sorter > div > select"));
        System.out.println("Sort buttons are :" + sortButtons.toString());
        System.out.println("Sort by list content = " + sortByButton.getText());
        WebElement selectElement = cDriver.findElement(By.cssSelector("div.category-products > div.toolbar > div.sorter > div > select"));
